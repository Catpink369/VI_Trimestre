...
const CART_STORAGE_KEY = 'gurama_cart';
...
export const CartProvider = ({ children }) => {
    // Estado inicial: intenta leer un carrito ya guardado en localStorage.
    // Si no hay nada guardado, o el JSON está corrupto, arranca vacío.
    ...
    // Cada vez que cartItems cambia (agregar, quitar, modificar cantidad,
    // vaciar), lo vuelve a guardar en localStorage. Así sobrevive a un
    // refresh de página o a navegar directo a /carrito.
    useEffect(() => {
        try {
